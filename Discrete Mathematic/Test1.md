...
1. Булева функция $y=f_{4}(x)$принимает значение,равное нулю,на наборах (0,3,5,8,10,12,15)и безразличное значение-на наборах (2,14).Построить схему с парафазными входами,реализующую данную функцию на элементах базиса (И-НЕ)и обладающую минимальной ценой (18 баллов)Определить реакцию схемы на безразличных наборах и пояснить ее (2 балла за каждый набор)
## Variant 4