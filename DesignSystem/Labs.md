...
1. Изучить:
   ...
   - состав стандартных драйверов I2C из библиотеки HAL и содержимое создаваемых
   генератором файлов i2c.c/.h (появляются в проекте после настройки соответствующих
   блоков).
2. Подготовить шаблон проекта для STM32CubeIDE, настроить тактовые частоты.
