...
- [MainPage/Distributed Database/Exam](#mainpagedistributed-databaseexam)
  ...
  - [Настройка физической репликации. `wal_keep_size`, слоты](#настройка-физической-репликации-wal_keep_size-слоты)
  - [物理复制的配置。`wal_keep_size` 和 slots](#物理复制的配置wal_keep_size-和-slots)
  - [1. Параметр `wal_keep_size`](#1-параметр-wal_keep_size)
  - [1. `wal_keep_size` 参数](#1-wal_keep_size-参数)
  - [2. Слоты репликации (Replication Slots)](#2-слоты-репликации-replication-slots)
  - [2. 复制槽](#2-复制槽)
...
### Настройка физической репликации. `wal_keep_size`, слоты  
### 物理复制的配置。`wal_keep_size` 和 slots  
...
### 2. Слоты репликации (Replication Slots)  
### 2. 复制槽  
