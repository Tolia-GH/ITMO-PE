...
- [MainPage/Distributed Database/Exam](#mainpagedistributed-databaseexam)
  - [1. Архитектура ANSI-SPARC](#1-архитектура-ansi-sparc)
  - [2. Архитектура PostgreSQL.  PostgreSQL架构](#2-архитектура-postgresql--postgresql架构)
  - [3. Разделяемая память PostgreSQL.  PostgreSQL的共享内存](#3-разделяемая-память-postgresql--postgresql的共享内存)
  - [4. Буферная память процессов PostgreSQL.  PostgreSQL进程的缓冲内存](#4-буферная-память-процессов-postgresql--postgresql进程的缓冲内存)
  - [5. Процессы, обеспечивающие работу PostgreSQL.  支持PostgreSQL运行的进程](#5-процессы-обеспечивающие-работу-postgresql--支持postgresql运行的进程)
  - [6. Системный каталог, организация, способы взаимодействия.  系统目录，组织方式及交互方式](#6-системный-каталог-организация-способы-взаимодействия--系统目录组织方式及交互方式)
  - [7. Схема, особенности работы со схемами в PostgreSQL, search\_path.  模式，PostgreSQL中使用模式的特点，search\_path](#7-схема-особенности-работы-со-схемами-в-postgresql-search_path--模式postgresql中使用模式的特点search_path)
  - [8. Управление доступом к данным в PostgreSQL, привилегии, пользователи, роли.  PostgreSQL中的数据访问管理，权限，用户，角色](#8-управление-доступом-к-данным-в-postgresql-привилегии-пользователи-роли--postgresql中的数据访问管理权限用户角色)
  - [9. Работа с ролями, INHERIT, NOINHERIT.  角色的使用，INHERIT, NOINHERIT](#9-работа-с-ролями-inherit-noinherit--角色的使用inherit-noinherit)
