...
- [Rubiesh 2](#rubiesh-2)
  ...
  - [Билет ?:](#билет--2)
      - [1. Протоколы MQTT их плюсы и минусы  协议及其优缺点](#1-протоколы-mqtt-их-плюсы-и-минусы--协议及其优缺点)
  ...
  - [Билет 8：](#билет-8)
      - [1.	основные компоненты bpms](#1основные-компоненты-bpms)
      - [2.	Протоколы их плюсы и минусы](#2протоколы-их-плюсы-и-минусы)
  ...
  - [Билет 9：](#билет-9)
      - [1.	JMS资源和消息](#1jms资源和消息)
      - [2.	Транзакции в Camunda:](#2транзакции-в-camunda)
  ...
  - [Билет 10：](#билет-10)
      - [1.	планировщик задачи: что зачем и где](#1планировщик-задачи-что-зачем-и-где)
      - [2. Rabbit MQ](#2-rabbit-mq)
      - [3.	Написать JMS сервер прием и передача](#3написать-jms-сервер-прием-и-передача)
  - [Билет 11：](#билет-11)
      - [1.	архитектура JMS](#1архитектура-jms)
      - [2.	Quartz - уже точно не помню, вроде способы конфигурации, и ещё что-то](#2quartz---уже-точно-не-помню-вроде-способы-конфигурации-и-ещё-что-то)
      - [3.	как сконфигурировать и запустить проект в Camunda (Сконфигурировать камунду, чтобы он был Standalone(через приложение)/Embedded (через pom)](#3как-сконфигурировать-и-запустить-проект-в-camunda-сконфигурировать-камунду-чтобы-он-был-standaloneчерез-приложениеembedded-через-pom)
  - [Билет 12：](#билет-12)
  ...
  - [Доп вопросы：](#доп-вопросы)
      ...
      - [4.	Распределенные системы JMS](#4распределенные-системы-jms)
...
#### 1. Протоколы MQTT их плюсы и минусы <br> 协议及其优缺点
