...
– получите вариант задания у преподавателя; – по полученным исходным данным, используя метод перешифрования, определите порядок числа e в конечном поле $Z_\varphi(N)$; 
