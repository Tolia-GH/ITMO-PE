...
- а) найти уравнение прямой регрессии $y$ на $x$;
  ...
  При построении таблицы надо выполнить проверку:
  ...
  где $s_x=\sqrt{214.38}\approx14.64$; $s_y=\sqrt{15642.38}\approx125.07$
...
случайные точки выборки $(X, Y)$.
  ...
  ![](pic/HomeWork-2.2.1.png)

  [pic sourse](https://www.desmos.com/calculator/fhssfv0z4a)
