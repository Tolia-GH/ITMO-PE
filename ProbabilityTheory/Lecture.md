...
Доказательство:
Так как Н]+Н2+... +Нп = О, то в силу свойств операций над событиями
А = А • Q = А . (Я1 + Я2 + ... + Яп) =
— А • Я1 + А • Яг + .. • + А • Я„. Из того, что Я; - Я, = о, следует, что (А • Hi) - (А • Hj) = 0, i / jy т. е. события А - я^ и А я также несовместны. Тогда по тео]>еме сложения вероятностей Р(А) — = Р(А - «,) + Р(А ■ Н2) + • ■ • + Р(А ■ Нп) т.е. Р(Л) = £ Р(А ■ Я,). По
L-I
теореме умножения вероятностей Р(А • Я,) — Р(Яг) - Р(А|Яг), откуда и следует формула полной вероятности.
В формуле полной вероятности события Я», Яг, • •., Нп обычно называют гипотезами} они исчерпывают все возможные предположения (гипотезы) относительно исходов как бы первого этапа опыта, событие А — один из возможных исходов btojxjio этапа.

### Формула Байеса

Следствием формулы полной вероятности является формула Байеса или теорема гипотез. Она позволяет переоценить всцюятности гипотез //,, принятых до опыта и называемых априорными («а priori», доопытные, лат.) по результатам уже проведенного опыта, т. е. найти условные вероятности Р(Нг\А), которые называют апостериорными («а posteriori», послеопытные).

Теорема. Пусть события Hi, Н2, Нп образуют полную группу событий. Тогда условная вероятность события (к = 1,п) при условии, что событие А произошло, задается формулой


где Р(А) = P(Hi) . Р(А\НХ) + ... + Р(Нп) • Р(А|ЯП) — формула полной вероятности

Доказательство:
Применив формулы условной вероятности и умножения вероятностей, имеем
PfH М) =	= P(Hk)-P(A\Hk)
1 А:| Р(Л)	Р(А)-
где Р(Л) — формула полной вероятности
