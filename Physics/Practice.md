...
## [MainPage](../index.md)/[Physics](README.md)/Practice
...
Сечение ствола гидромонито­ра (рис. 2) меняется от $S_1=50\ см^2$ до $S_2=5.0\ см^2$. Найти модуль и на­правление горизонтальной силы, воз­никающей в креплении ствола (сече­ние $1$), если скорость струи на выходе $v_2=25\ м/с$. Вязкостью пренебречь.
...
Из формулы Бернулли, мы знаем

$$p_1+\frac{1}{2}\rho v_1^2=p_0+\frac{1}{2}\rho v_2^2=Const$$

где $p_0$ - атмосферное давление

$$p_1=p_0+\frac{1}{2}\rho v_2^2-\frac{1}{2}\rho v_1^2$$
