...
Или в векторно-матричном виде: $\vec{x} = \vec{C}\vec{x} + \vec{D}$, где x – вектор неизвестных, 𝐶 ‒ матрица коэффициентов преобразованной системы размерности
n*n, 𝐷 ‒ вектор правых частей преобразованной системы.
