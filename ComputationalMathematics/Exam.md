...
- при фиксированном левом конце хорд, тогда $х_0=b$ (рис. 1а)  
  Рабочая формула метода:  

  $$x_{i+1}=x_i-\frac{a-x_i}{f(a)-f(x_i)}f(x_i)$$

- при фиксированном правом конце хорд, тогда $х_0=a$ (рис. 1б)  
  Рабочая формула метода:
...
- 1 случай.  
  $x_0 = a$, граница $b$ - зафиксирована  
  Производные имеют одинаковые знаки на отрезке $[a, b]$:  
  $f'(x)\cdot f''(x)\gt0$  
  $f'(x)\gt0$ и $f''(x)\gt0$, функция возрастает и выпукла вниз  
  $f'(x)\lt0$ и $f''(x)\lt0$, функция убывает и выпукла вверх  
- 2 случай.  
  $x_0=b$, граница $a$ - зафиксирована  
  Производные имеют разные знаки на отрезке $[a,b]$:  
  $f'(x)\cdot f''(x)\lt0$  
  $f'(x)\lt0$ и $f''(x)\gt0$, функция убывает и выпукла вниз  
  $f'(x)\gt0$ и $f''(x)\lt0$, функция возрастает и выпукла вверх  
