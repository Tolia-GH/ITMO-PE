...
Или в векторно-матричном виде: $\vec{x} = \vec{C}\vec{x} + \vec{D}$, где x – вектор неизвестных, $\vec{C}$ ‒ матрица коэффициентов преобразованной системы размерности
n*n, $\vec{D}$ ‒ вектор правых частей преобразованной системы.
