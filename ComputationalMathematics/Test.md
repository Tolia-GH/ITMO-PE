...
4. Имеет ли место сходимость к найденному корню $x^∗ = 0.2304$ уравнения $2𝑥 + \lg(2𝑥 + 3) = 1$, если $\lambda=-0.4$ и $𝑥_0 = 0$?
...
4. Имеет ли место сходимость к найденному корню $x^∗ = 0.2304$ уравнения $2x + \lg(2x + 3) = 1$, если $\lambda=0.4$ и $𝑥_0 = 0$?
