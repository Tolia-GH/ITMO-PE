...
С. 62 - 66: прочитайте  тексты 31 - 34, найдите значения незнакомых слов, выполните задания:
...
- 63-64, 65, 66 - ответы на вопросы (устно, будем обсуждать на занятии)
  ...
  **Притекстовые задания:**
  ...
  8. Сколько способов защиты описывает автор? Знаете ли вы дру- гие способы?
  ...
  **Притекстовые задания:**
  ...
  6. Что означает в 5 абзаце «уровень (безопастности) не намного
  выше»?
  ...
  **Притекстовые задания:**
  1. Прочитайте текст, объясните значение новых слов.
  2. Каково отношение к хакингу в текстах 33 и 34? Докажите свою
  точку зрения.
