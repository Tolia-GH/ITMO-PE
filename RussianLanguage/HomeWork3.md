...
2. уч. РЯ в проф.деят. Инф.технологии_с. 5-8 - выучить языковые х-ристики НСР. Найти в статье _ ПРОЦЕСС ПРОГРАММНОЙ ИНЖЕНЕРИИ (см.ст.от ВанМ.) яз.х-ки НСР. Выделить их прямо в тексте разным цветом и прикрепить файл с выполненным заданием.